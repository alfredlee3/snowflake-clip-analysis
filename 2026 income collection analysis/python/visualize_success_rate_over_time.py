...
print("Running Overall Success Rate Over Time Analysis...")
...
fig.suptitle('Overall Success Rate Over Time - April 2025 Cohort',
...
ax.set_title('Approved Outright + PIE with Income Collected',
             fontsize=16, pad=15)
...
# Save the plot
output_file = '/Users/Alfred.Lee/Documents/github/visualizations/success_rate_over_time.png'
plt.savefig(output_file, dpi=300, bbox_inches='tight')
print(f"\nVisualization saved to: {output_file}")

# Display summary statistics
print("\n" + "=" * 120)
print("SUCCESS RATE SUMMARY (April 2025 Cohort)")
print("=" * 120)
